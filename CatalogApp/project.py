...
def fbconnect():
    ...
    app_id = json.loads(open(os.path.join(os.path.dirname(__file__), "fb_client_secrets.json"), 'r').read())[
        'web']['app_id']
    app_secret = json.loads(
        open(os.path.join(os.path.dirname(__file__), 'fb_client_secrets.json'), 'r').read())['web']['app_secret']
...
def gconnect():
    ...
    client_id = json.loads(open(os.path.join(os.path.dirname(__file__), 'client_secrets.json'), 'r').read())[
        'web']['client_id']
